...
import { Home, Bookmark, PlusCircle, User, Utensils } from "lucide-react";

const Sidebar = () => {
  return (
    <div className="w-64 min-h-screen bg-green-700 text-white p-6 flex flex-col">
      <h2 className="text-2xl font-bold mb-6">Recipe App</h2>
